 ...
 */
 ( function ( THREE ) { "use strict";
	...
	THREE.Octree.prototype = {
		...
		rebuild: function (assumeAllObjectsHaveChangedPosition) {
			...
			for ( i = 0, l = this.objectsData.length; i < l; i++ ) {
				...
				if ( node instanceof THREE.OctreeNode && (assumeAllObjectsHaveChangedPosition || !objectData.positionLast.equals( objectData.position )) ) {
